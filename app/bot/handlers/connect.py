...
async def connect_issues(callback: CallbackQuery, settings: Settings) -> None:
    ...
    text = (
        ...
        "<b>1. Ссылка скопировалась не полностью</b>\n"
        "Нажмите на ссылку в боте ещё раз — она скопируется целиком.\n\n"
        "<b>2. Приложение не реагирует после импорта</b>\n"
        "Закройте приложение полностью и откройте снова, затем нажмите Connect.\n\n"
        "<b>3. VPN подключился, но сайты не открываются</b>\n"
        "Отключите и включите VPN ещё раз. Если не помогло — удалите профиль и добавьте заново.\n\n"
        "<b>4. На iPhone спрашивает разрешение</b>\n"
        "Нажмите «Разрешить» — это стандартный запрос на создание VPN-профиля.\n\n"
        "Всё ещё не работает? Напишите нам 👇"
    )
