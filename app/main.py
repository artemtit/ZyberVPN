...
def _buy_keyboard(text: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text=text, callback_data="buy_open", style="green")]])
        ...
        try:
            ...
            for user in expiring_7d:
                if str(user.get("plan") or "") == "trial":
                    continue  # trial users get their own notifications
                ...
                try:
                    await bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            inline_keyboard=[[InlineKeyboardButton(text="🔄 Продлить подписку", callback_data="buy_open", style="green")]]
                        ),
                    )
            ...
            for user in expiring_trial_1h:
                ...
                try:
                    ...
                    logging.exception("Failed to send trial 1h notification tg_id=%s", tg_id)
                await asyncio.sleep(0.1)
            ...
            for user in expiring_1d:
                ...
                try:
                    await bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            inline_keyboard=[[InlineKeyboardButton(text="⚡ Продлить сейчас", callback_data="buy_open", style="green")]]
                        ),
                    )
                    await users_repo.set_notified(tg_id, "1d")
                except TelegramForbiddenError:
