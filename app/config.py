...
class Settings:
    ...
    posthog_api_key: str  # PostHog project API key (phc_...); empty = tracking disabled
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        vpn_limit_ip=max(1, int(os.getenv("VPN_LIMIT_IP", "3"))),
        vpn_total_gb=max(0, int(os.getenv("VPN_TOTAL_GB", "0"))),
        ...
        xray_device_window_hours=max(1, int(os.getenv("XRAY_DEVICE_WINDOW_HOURS", "168"))),
